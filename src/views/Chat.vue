  ...
  ><div class="container-fluid mt-4">
    <div class="mb-3">
      ...
      <span class="ml-1" v-if="user && user.uid !== hostID">
        Hosted by: <strong class="text-danger">{{ hostDisplayName }}</strong></span
      >
    </div>
    <div class="row" v-if="(user !== null && user.uid === hostID) || attendeeApproved">
      ...
      <div class="col-md-4">
        ...
        <button v-if="attendeeJoined" @click="doLeave" type="button" class="btn btn-danger mr-1">
          Leave
        </button>
        ...
        <ul class="list-unstyled">
          <li v-for="attendee in attendeesApproved" :key="attendee.id">
            <a
              ...
              v-if="user && user.uid === hostID && user.uid !== attendee.id"
              type="button"
              class="mr-2"
              title="Disapprove attendee"
            >
